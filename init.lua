...
core.register_node("vault:ammo_chest", {
		...
		tiles = {"vault_ammo_chest_top.png", "vault_ammo_chest_down.png", "vault_ammo_chest_right.png",
		"vault_ammo_chest_left.png", "vault_ammo_chest_back.png", "vault_ammo_chest_front.png"},
